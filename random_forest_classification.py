...
classifier_without_gender = RandomForestClassifier(n_estimators=10, criterion='entropy')
classifier_with_gender = RandomForestClassifier(n_estimators=10, criterion='entropy')
